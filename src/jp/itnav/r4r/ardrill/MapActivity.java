...
public class MapActivity extends FragmentActivity implements OnClickListener,OnMarkerDragListener
	{
	...
	public void onClick(View v) {
		try {
			...
			MyCountDownTimer mcdt = new MyCountDownTimer(1000, 1000);
			mcdt.start();
			}
		} catch (NullPointerException e) {
			setToast("Retrieving Current Location");
	...
	public void onMarkerDragEnd(Marker marker) {
		...
		sp.edit()
				.putString("goallatitude",
						String.valueOf(marker.getPosition().latitude))
				.putString("goallongitude",
						String.valueOf(marker.getPosition().longitude)).commit();
	}
