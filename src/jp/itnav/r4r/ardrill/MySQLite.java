...
public class MySQLite {
		...
		try {
			...
			try {
				...
				for (int i = 0; i < count; i++) {
					Log.v("cursor1",String.valueOf(cursor.getInt(0)));
					Log.v("cursor1",String.valueOf(cursor.getDouble(1)));
					Log.v("cursor2",String.valueOf(cursor.getDouble(2)));
					cursor.moveToNext();
				}
	...
	public double DistanceSerch() {
		...
		if(count==0){
			Toast.makeText(mContext, "NoData", Toast.LENGTH_LONG).show();
		}
		return distance;
